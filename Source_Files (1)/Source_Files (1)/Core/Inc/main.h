...
#define TC8002_CTRL_Pin GPIO_PIN_0
#define TC8002_CTRL_GPIO_Port GPIOA
#define DS3231_INT_Pin GPIO_PIN_1
#define DS3231_INT_GPIO_Port GPIOA
#define QJ008_CTRL_Pin GPIO_PIN_2
#define QJ008_CTRL_GPIO_Port GPIOA
#define USB_CNCT_Pin GPIO_PIN_4
#define USB_CNCT_GPIO_Port GPIOA
#define OLED_D0_Pin GPIO_PIN_5
#define OLED_D0_GPIO_Port GPIOA
#define PH_CNCT_Pin GPIO_PIN_6
#define PH_CNCT_GPIO_Port GPIOA
